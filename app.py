        ...
        hide_index=True
            ...
            with col2:
                ...
                if not emoji_df.empty:
                    ...
                    # Emoji glyphs are drawn by Streamlit's own HTML table above,
                    # not by matplotlib -- DejaVu Sans has no emoji glyphs and
                    # matplotlib's Agg/FreeType backend can crash (segfault)
                    # trying to rasterize them, so keep them out of the figure.
                    ax.legend(
                        wedges,
